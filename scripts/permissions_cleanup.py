...
def cleanup_permissions() -> None:
    ...
    print(f"# of permission view menues is: {len(pvms)}")
    ...
    print(f"Stage 1: # of permission view menues is: {len(pvms)}")
    ...
    print(f"Stage 2: # of permission view menues is: {len(pvms)}")
